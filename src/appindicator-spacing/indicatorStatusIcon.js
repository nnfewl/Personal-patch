...
class IndicatorBaseStatusIcon extends PanelMenu.Button {
    ...
    _monitorIconEffects() {
        ...
        if (!this._icon && monitoring) {
            ...
            Util.disconnectSmart(settings, this, this._indicatorPaddingIds);
            delete this._indicatorPaddingIds;
            ...
            this._indicatorPaddingIds =
                Util.connectSmart(settings, 'changed::indicator-padding', this,
                    this._updateCompactMode);
        }
    }
